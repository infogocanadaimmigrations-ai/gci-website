...
(function () {
  ...
  if (!document.getElementById('gci-navfix')) {
    ...
    fix.id = 'gci-navfix';
    fix.textContent = '.ic{display:flex!important;align-items:center!important;justify-content:center!important}.ic svg{width:24px;height:24px;display:block}@media(max-width:880px){#nav .links{display:flex!important}.svc-grid{grid-template-columns:1fr!important}.svc h4{font-size:22px;line-height:1.3}}';
